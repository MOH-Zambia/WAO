...
class Distance extends Generic_input {
    ...
    function index() {
        ...
        $this->form_validation->set_rules('road_distance', 'Road Distance', 'callback_combo_check');
    ...
    function update($id) {
        ...
        $data['gender'] = $this->distance_model->get_gender_dropdown();
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('distance/dashboard/' . $id);
        }
        $this->load->view('footer');
    }
