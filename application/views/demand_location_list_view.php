<div class="row">
    ...
    <div class="list-group">
        <a href="<?php echo site_url('demand_location/collectionMapping'); ?>" class="list-group-item">
            <h4 class="list-group-item-heading">Demand Location Mapping</h4>
            <p class="list-group-item-text">Merge Same Demand Locations.</p>
        </a>
    </div>
