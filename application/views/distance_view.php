...
<div class="row">
    <div class="col-sm-offset-3 col-lg-6 col-sm-6 well">
        <legend>Add Distance Lookup</legend>
        <?php
        $attributes = array("class" => "form-horizontal", "id" => "distanceform", "name" => "distanceform");
        echo form_open("distance/index", $attributes);
        ?>
        <fieldset>
            ...
            <div class="form-group">
                <div class="row colbox">
                    <div class="col-lg-4 col-sm-4">
                        <label for="road_distance" class="control-label m">Road Distance (km) *</label>
                    </div>
                    <div class="col-lg-8 col-sm-8">
                        <input id="road_distance" name="road_distance" placeholder="road_distance" type="text" class="form-control" />
