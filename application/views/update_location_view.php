        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="longitude_coordinate" name="longitude_coordinate" placeholder="longitude_coordinate" type="text" class="form-control" value="<?php echo $emp->longitude_coordinate; ?>" />
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="latitude_coordinate" name="latitude_coordinate" placeholder="latitude_coordinate" type="text" class="form-control" value="<?php echo $emp->latitude_coordinate; ?>" />
