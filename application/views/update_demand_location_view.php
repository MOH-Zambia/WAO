        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="demand_longitude_coordinate" name="demand_longitude_coordinate" placeholder="longitude_coordinate" type="text" class="form-control" value="<?php echo $emp->demand_longitude_coordinate; ?>" />
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="demand_latitude_coordinate" name="demand_latitude_coordinate" placeholder="latitude_coordinate" type="text" class="form-control" value="<?php echo $emp->demand_latitude_coordinate; ?>" />
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="location_budget" name="location_budget" placeholder="location_budget" type="text" class="form-control" value="<?php echo $emp->location_budget; ?>" />
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="penalty_unfulfilled_demand" name="penalty_unfulfilled_demand" placeholder="penalty_unfulfilled_demand" type="text" class="form-control" value="<?php echo $emp->penalty_unfulfilled_demand; ?>" />
