...
<div class="row">
    <div class="col-sm-offset-3 col-lg-6 col-sm-6 well">
        <legend>Add Study Location</legend>
        <?php
        $attributes = array("class" => "form-horizontal", "id" => "locationform", "name" => "locationform");
        echo form_open("location/index", $attributes);
        ?>
        <fieldset>
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="location_name" name="location_name" placeholder="location_name" type="text" class="form-control"  value="<?php echo set_value('location_name'); ?>" />
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="longitude_coordinate" name="longitude_coordinate" placeholder="longitude_coordinate" type="text" class="form-control"  value="<?php echo set_value('longitude_coordinate'); ?>" />
             ...
             <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="latitude_coordinate" name="latitude_coordinate" placeholder="latitude_coordinate" type="text" class="form-control"  value="<?php echo set_value('latitude_coordinate'); ?>" />
