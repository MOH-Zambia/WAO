        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="demand_location_name" name="demand_location_name" placeholder="demand_location_name" type="text" class="form-control"  value="<?php echo set_value('demand_location_name'); ?>" />
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="demand_longitude_coordinate" name="demand_longitude_coordinate" placeholder="longitude_coordinate" type="text" class="form-control"  value="<?php echo set_value('longitude_coordinate'); ?>" />
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="demand_latitude_coordinate" name="demand_latitude_coordinate" placeholder="latitude_coordinate" type="text" class="form-control"  value="<?php echo set_value('latitude_coordinate'); ?>" />
            ...
            <div class="form-group">
                <div class="row colbox">
                    ...
                    <div class="col-lg-8 col-sm-8">
                        <input id="location_budget" name="location_budget" placeholder="location_budget" type="text" class="form-control"  value="<?php echo set_value('location_budget'); ?>" />
